<template>
    <view>
        <view class="from">
            ...
            <view class="from-item">
                <view class="font-30">paypal账号</view>
                <input type="text" v-model="from.bank_card" class="font-30" placeholder="请输入paypal账号" placeholder-class="D7" />
            </view>
        ...
        <view class="buttom font-30" @tap="save">确定</view>
