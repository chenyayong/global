<template>
    <view>
        ...
        <view class="from">
            <picker :range="list" range-key="identity_name" @change="picker_change">
                <view class="from-item">
                    ...
                    <view :class="['more font-28', formData.identity_id ? '' : 'cc']">{{ list[listIndex] && list[listIndex].identity_name }}</view>
                </view>
            </picker>
        </view>
        ...
        <view class="from">
            ...
            <view class="from-item"><view class="font-30">公司法人身份证正反面</view></view>
            <view class="img-box">
            ...
            <view class="from-item"><view class="font-30">公司营业执照扫描件</view></view>
            <view class="img-box"><image class="zhizhao-img" :src="$image + formData.license" @tap="chooseLin"></image></view>
            <view class="from-item"><view class="font-30">企业支付宝截图或开户行许可证照片</view></view>
            <view class="img-box"><image class="ali-img" :src="$image + formData.bank_license" @tap="chooseBank"></image></view>
        </view>
        ...
        <view class="from">
            ...
            <view class="from-item"><view class="font-30">附件</view></view>
            <view class="img-list">
                ...
                <view class="img-box" v-if="imgList.length < 3"><image class="ali-img" @tap="chooseAcc"></image></view>
            </view>
        </view>
...
export default {
    ...
    onLoad() {
        this.$http('get|api/user/apply_partner').then(res => {
            ...
            this.formData.identity_id = this.list[this.listIndex] ? this.list[this.listIndex].id : ''
            if (res.result.user_embassy) {
                // this.formData = res.result.user_embassy
                this.formData = Object.assign(this.formData, res.result.user_embassy)
    ...
    methods: {
        ...
        picker_change(e) {
            ...
            this.formData.identity_id = this.list[this.listIndex].id
            // console.log(this.formData.identity_id)
        ...
        submit() {
            ...
            this.$http('post|api/user/apply_partner', this.formData)
                .then(res => {
                    // console.log(res)
