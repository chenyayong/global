<template>
    <view>
        ...
        <swiper class="swiper" :indicator-dots="true" :autoplay="true" indicator-color="rgba(255,255,255,0.3)" indicator-active-color="rgb(255,255,255)" :interval="5000" :duration="1000">
            ...
            to_page(item) {
                ...
                switch (item.media_type) {
                    ...
                    case 3:
                        ...
                        // window.open(item.ad_link)https://app.global3plus.com/public/upload/banner_video/juker.mp4
                        if (item.ad_link.indexOf('.mp4')) {
                            uni.navigateTo({
                                url: '/pages/web-view?src=' + item.ad_link
                            })
                        } else {
