        ...
        <form @submit="formSubmit">
            <view class="from">
                ...
                <view class="from-item">
                    ...
                    <input
                        class="font-28 no-bor"
                        :type="isPsw ? 'text' : 'password'"
                        v-model="from.password"
                        name="password"
                        placeholder="设置密码6-12位字母+数字"
                ...
                <view class="radio">
                    <radio-group @change="isChange">
                        ...
                        <!-- 深圳市创星视界科技有限公司 -->
                        <radio color="#4E6EF3" value="agree" />
                        我已阅读并同意
                        <text @tap="go_agree(3)">网络服务协议</text>
                        和
                        <text @tap="go_agree(4)">隐私政策</text>
                    </radio-group>
                </view>
            </view>
...
export default {
    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            if (checkRes) {
                if (this.isAgree) {
                    this.$http('post|api/User/reg', this.from)
                        .then(res => {
